...
public class BeanCommunities implements Serializable {
	...
	public BeanCommunities() {
		...
		MS = Factories.services.createMemberService();
	...
	public List<Community> listJoined() {
		return MS.listJoined(loginInfo.getSessionUser());
	}

	public boolean ableToJoin(Community comunidad) {
		return MS.ableToJoin(comunidad, loginInfo.getSessionUser());
	}
	...
	public String create() {
		...
		listAll();
		return MS.join(findByName(this.nombre), loginInfo.getSessionUser());
	}
	...
	public String join(Community community) {
		...
		listAll();
		return MS.join(community, loginInfo.getSessionUser());
	}
	...
	public String leave(Community community) {
		...
		listAll();
		return MS.leave(community, loginInfo.getSessionUser());
	}
